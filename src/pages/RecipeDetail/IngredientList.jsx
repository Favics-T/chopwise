export default function IngredientsList({ ingredients, checkedIngredients, toggleIngredient, clearChecks }) {
  return (
    <section className="mb-12">
      <div className="flex items-center justify-between mb-8">
        <h3 className="font-display text-3xl font-bold">Ingredients</h3>
        <span className="text-secondary font-black text-xs uppercase tracking-widest bg-secondary/10 px-3 py-1 rounded-lg">
        ...
        {ingredients.map((item, i) => {
          ...
          return (
            ...
            >
              ...
              <span className={`text-on-surface text-lg transition-all ${
                isChecked ? 'line-through opacity-40 font-medium' : 'font-semibold'
              }`}>
                {item.name}
              </span>
